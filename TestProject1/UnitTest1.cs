...
public class UserServiceTests
{
    ...
    public void AddUser_Should_Return_False_When_Missing_FirstName()
    {
        ...
        //Act
        bool result = service.AddUser(null, null, "kowalski@wp.pl", new DateTime(1980, 1, 1), 1);
    ...
    public void AddUser_Should_Return_False_When_Missing_At_Sign_And_Dot_In_Email()
    {
        ...
        //Act
        bool result = service.AddUser("John", "Doe", "kowalskiwppl", new DateTime(1980, 1, 1), 1);
    ...
    public void AddUser_Should_Return_False_When_Younger_Then_21_Years_Old()
    {
        ...
        //Act
        bool result = service.AddUser("John", "Doe", "kowalski@wp.pl", new DateTime(2010, 1, 1), 1);
    ...
    public void AddUser_Should_Return_True_When_Very_Important_Client()
    {
        ...
        //Act
        bool result = service.AddUser("John", "Malewski", "kowalski@wp.pl", new DateTime(1980, 1, 1), 2);
    ...
    public void AddUser_Should_Return_True_When_Important_Client()
    {
        ...
        //Act
        bool result = service.AddUser("John", "Smith", "smith@gmail.pl", new DateTime(1980, 1, 1), 3);
    ...
    public void AddUser_Should_Return_True_When_Normal_Client()
    {
        ...
        //Act
        bool result = service.AddUser("John", "Kwiatkowski", "kwiatkowski@wp.pl", new DateTime(1980, 1, 1), 5);
    ...
    public void AddUser_Should_Return_False_When_Normal_Client_With_No_Credit_Limit()
    {
        ...
        //Act
        bool result = service.AddUser("John", "Kowalski", "kowalski@wp.pl", new DateTime(1980, 1, 1), 1);
